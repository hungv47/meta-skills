...
provenance:
  extracts_from: marketing-skills/skills/copywriting/SKILL.md § "Quality Gate" (8-bullet checklist pattern), contrast with meta-skills/references/shared-critic-rubrics.md (full multi-dim library)
