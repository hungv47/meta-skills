...
Promote a loop learning into `docs/forsvn/experience/` only when the evidence is strong enough to reuse across sessions.
...
|---|---|
| Audience behavior, objections, language | `docs/forsvn/experience/audience.md` |
| Offer economics, pricing, buying trigger | `docs/forsvn/experience/business.md` |
| Product mechanism, claim boundary, feature proof | `docs/forsvn/experience/product.md` |
| Brand voice, trust pattern, taboo | `docs/forsvn/experience/brand.md` |
| Goal, metric, channel result, campaign rule | `docs/forsvn/experience/goals.md` |
...
2. **Reusable audience/offer/product truth:** promote to `docs/forsvn/experience/`.
...
- `docs/forsvn/artifacts/research/evals/` when the evaluation spans multiple loops or canonical research artifacts.
...
```text
docs/forsvn/artifacts/meta/records/critic-overrides.md
```
...
Shared rubrics should live in `meta-skills/references/shared-critic-rubrics.md` and be referenced from skill-specific critics. Keep the domain-specific application in the skill.
