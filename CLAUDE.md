...
- **Loop-first when measurable**: When an initiative has a real-world metric and future cycles, use `skills-resources/{marketing|product|research}/loops/[slug]/` so strategy, execution, evals, results, and learnings stay together.
...
| `eval-loop` | `skills-resources/{marketing|product|research}/loops/[slug]/program.md`, `context.md`, `results.tsv`, `learnings.md` | Loop-centered workspace for measurable strategy → execution → evaluation cycles. |
