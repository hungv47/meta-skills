...
2. **Artifacts on disk** — `architecture/system-architecture.md`, `.agents/skill-artifacts/meta/specs/*.md`, every `.agents/skill-artifacts/product/flow/*.md`
...
**Read order:**
1. Pipeline: `architecture/system-architecture.md`, `.agents/skill-artifacts/meta/specs/*.md`, `.agents/skill-artifacts/product/flow/*.md`.
