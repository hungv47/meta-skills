...
sources:
  - id: gstack-office-hours
    title: "office-hours (Garry Tan / gstack — github.com/garrytan/gstack)"
    url: https://github.com/garrytan/gstack/blob/main/office-hours/SKILL.md
    accessed: 2026-05-09
    tier: primary
  - id: yc-startup-school
    title: "Y Combinator Startup School — How to Talk to Users"
...
> *"Specificity is the only currency. Vague answers get pushed. 'Enterprises in healthcare' is not a customer. 'Everyone needs this' means you can't find anyone. You need a name, a role, a company, a reason."* [verbatim; gstack-office-hours]

> *"Interest is not demand. Waitlists, signups, 'that's interesting' — none of it counts. Behavior counts. Money counts. Panic when it breaks counts. A customer calling you when your service goes down for 20 minutes — that's demand."* [verbatim; gstack-office-hours]

> *"Watch, don't demo. Guided walkthroughs teach you nothing about real usage. Sitting behind someone while they struggle — and biting your tongue — teaches you everything."* [verbatim; gstack-office-hours]

> *"The status quo is your real competitor. Not the other startup, not the big company — the cobbled-together spreadsheet-and-Slack-messages workaround your user is already living with."* [verbatim; gstack-office-hours]

> *"Narrow beats wide, early. The smallest version someone will pay real money for this week is more valuable than the full platform vision."* [verbatim; gstack-office-hours]
...
Before discover asks any of the six, it should commit to the posture that makes the questions work. From `office-hours` [gstack-office-hours]:

> *"Be direct to the point of discomfort. Comfort means you haven't pushed hard enough. Your job is diagnosis, not encouragement. Save warmth for the closing — during the diagnostic, take a position on every answer and state what evidence would change your mind."* [verbatim]

> *"Push once, then push again. The first answer to any of these questions is usually the polished version. The real answer comes after the second or third push."* [verbatim]

> *"Calibrated acknowledgment, not praise. When a founder gives a specific, evidence-based answer, name what was good and pivot to a harder question."* [verbatim]

> *"Name common failure patterns. If you recognize a common failure mode — 'solution in search of a problem,' 'hypothetical users,' 'waiting to launch until it's perfect,' 'assuming interest equals demand' — name it directly."* [verbatim]

> *"End with the assignment. Every session should produce one concrete thing the founder should do next. Not a strategy — an action."* [verbatim]

---

## 3. The Anti-Sycophancy Rules

These are non-negotiable. Verbatim from `office-hours` [gstack-office-hours]:
...
- Take a position on every answer. State your position AND what evidence would change it. *"This is rigor — not hedging, not fake certainty."* [verbatim]
...
> **Ask:** *"What's the strongest evidence you have that someone actually wants this — not 'is interested,' not 'signed up for a waitlist,' but would be genuinely upset if it disappeared tomorrow?"* [verbatim; gstack-office-hours]

**Push until you hear:** *"Specific behavior. Someone paying. Someone expanding usage. Someone building their workflow around it. Someone who would have to scramble if you vanished."* [verbatim]

**Red flags:** *"'People say it's interesting.' 'We got 500 waitlist signups.' 'VCs are excited about the space.' None of these are demand."* [verbatim]

**Diagnostic depth — Q1 follow-up rules** [verbatim/adapted from gstack-office-hours]:
...
> **Ask:** *"What are your users doing right now to solve this problem — even badly? What does that workaround cost them?"* [verbatim; gstack-office-hours]

**Push until you hear:** *"A specific workflow. Hours spent. Dollars wasted. Tools duct-taped together. People hired to do it manually. Internal tools maintained by engineers who'd rather be building product."* [verbatim]

**Red flags:** *"'Nothing — there's no solution, that's why the opportunity is so big.' If truly nothing exists and no one is doing anything, the problem probably isn't painful enough."* [verbatim]

**What this question diagnoses:** Whether the problem is painful enough to motivate behavior — even bad behavior. The status quo is the real competitor [gstack-office-hours operating principle]. If the user has no workaround, the user has no problem.
...
> **Ask:** *"Name the actual human who needs this most. What's their title? What gets them promoted? What gets them fired? What keeps them up at night?"* [verbatim; gstack-office-hours]

**Push until you hear:** *"A name. A role. A specific consequence they face if the problem isn't solved. Ideally something the founder heard directly from that person's mouth."* [verbatim]

**Red flags:** *"Category-level answers. 'Healthcare enterprises.' 'SMBs.' 'Marketing teams.' These are filters, not people. You can't email a category."* [verbatim]

**Forcing exemplar** [verbatim from gstack-office-hours]:
...
> **Ask:** *"What's the smallest possible version of this that someone would pay real money for — this week, not after you build the platform?"* [verbatim; gstack-office-hours]

**Push until you hear:** *"One feature. One workflow. Maybe something as simple as a weekly email or a single automation. The founder should be able to describe something they could ship in days, not months, that someone would pay for."* [verbatim]

**Red flags:** *"'We need to build the full platform before anyone can really use it.' 'We could strip it down but then it wouldn't be differentiated.' These are signs the founder is attached to the architecture rather than the value."* [verbatim]

**Bonus push:** *"What if the user didn't have to do anything at all to get value? No login, no integration, no setup. What would that look like?"* [verbatim]
...
> **Ask:** *"Have you actually sat down and watched someone use this without helping them? What did they do that surprised you?"* [verbatim; gstack-office-hours]

**Push until you hear:** *"A specific surprise. Something the user did that contradicted the founder's assumptions. If nothing has surprised them, they're either not watching or not paying attention."* [verbatim]

**Red flags:** *"'We sent out a survey.' 'We did some demo calls.' 'Nothing surprising, it's going as expected.' Surveys lie. Demos are theater. And 'as expected' means filtered through existing assumptions."* [verbatim]

**The gold:** *"Users doing something the product wasn't designed for. That's often the real product trying to emerge."* [verbatim]
...
> **Ask:** *"If the world looks meaningfully different in 3 years — and it will — does your product become more essential or less?"* [verbatim; gstack-office-hours]

**Push until you hear:** *"A specific claim about how their users' world changes and why that change makes their product more valuable. Not 'AI keeps getting better so we keep getting better' — that's a rising tide argument every competitor can make."* [verbatim]

**Red flags:** *"'The market is growing 20% per year.' Growth rate is not a vision. 'AI will make everything better.' That's not a product thesis."* [verbatim]
...
You don't always ask all six. From `office-hours` [verbatim; gstack-office-hours]:
...
These are worked BAD-vs-GOOD applications discover should pattern-match against. **Spend disproportionate effort here — discover loads this playbook on every non-trivial invocation specifically to use these patterns.** All five patterns below are verbatim from `office-hours` [gstack-office-hours].
...
- **Source:** gstack-office-hours, Pushback Patterns Pattern 1; engages Q3 (Desperate Specificity).

### Pattern 2: Social Proof → Demand Test

- **Trigger:** Founder cites user reactions ("everyone loves it," "people are excited").
- **BAD:** *"That's encouraging! Who specifically have you talked to?"*
- **GOOD:** *"Loving an idea is free. Has anyone offered to pay? Has anyone asked when it ships? Has anyone gotten angry when your prototype broke? Love is not demand."*
- **Source:** gstack-office-hours, Pushback Patterns Pattern 2; engages Q1 (Demand Reality).
...
- **Source:** gstack-office-hours, Pushback Patterns Pattern 3; engages Q4 (Narrowest Wedge).

### Pattern 4: Growth Stats → Vision Test

- **Trigger:** Founder cites tailwind / market-growth stats as a substitute for thesis.
...
- **Source:** gstack-office-hours, Pushback Patterns Pattern 4; engages Q6 (Future-Fit).
...
- **Source:** gstack-office-hours, Pushback Patterns Pattern 5; engages Q1 + Q5.
...
2. **Don't ask all six in one round-trip.** *"Ask these questions ONE AT A TIME via AskUserQuestion. Push on each one until the answer is specific, evidence-based, and uncomfortable."* [verbatim; gstack-office-hours] Batching the six destroys the push-and-wait dynamic that makes them work.

3. **Don't accept the first answer.** *"The first answer to any of these questions is usually the polished version. The real answer comes after the second or third push."* [verbatim] If discover takes the first answer, it has done sub-skill work.

4. **Don't soften "name the actual human."** Q3 only works at human-resolution. *"You can't email a category."* [verbatim] If discover lets the founder stay at "product managers at mid-market SaaS companies," Q3 has been violated.

5. **Don't equate signups with demand.** Q1 is specifically built to defeat this conflation. Waitlists are red-flag evidence in this frame. *"Interest is not demand."* [verbatim]
...
8. **Don't praise specific answers without pivoting to a harder question.** *"Calibrated acknowledgment, not praise."* [verbatim] Lingering on a good answer feels nice but stalls diagnostic depth. *"The best reward for a good answer is a harder follow-up."* [verbatim]

9. **Don't apply this playbook to builder mode.** From `office-hours` [gstack-office-hours], "Builder Mode" is a separate posture for hackers / hobbyists / open-source contributors / hackathon work. The six questions are the *startup mode* diagnostic. Builder mode uses different questions ("what's the coolest version?", "who would say whoa?", "fastest path to something shareable?"). Discover should detect mode before applying questions.

10. **Don't push past the second escape-hatch attempt.** *"If the user pushes back a second time, respect it — proceed... immediately. Don't ask a third time."* [verbatim] Discover is a diagnostic, not an interrogation. If the user ejects twice, route to alternatives generation.
...
- **Builder mode** (hackathon, hobby, OSS, learning project): Don't apply the six. From `office-hours` [gstack-office-hours], builder mode uses delight-oriented questions:
  - *"What's the coolest version of this?"*
  - *"Who would you show this to? What would make them say 'whoa'?"*
  - *"What's the fastest path to something you can actually use or share?"*
  - *"What existing thing is closest to this, and how is yours different?"*
  - *"What would you add if you had unlimited time? What's the 10x version?"*
- **Vibe shift mid-session:** *"If the user starts in builder mode but says 'actually I think this could be a real company' or mentions customers, revenue, fundraising — upgrade to Startup mode naturally. Say something like: 'Okay, now we're talking — let me ask you some harder questions.'"* [verbatim; gstack-office-hours]
...
- **Where does Q1 push end?** *"Push once, then push again"* [verbatim] — but how many pushes is too many before the founder ejects? The escape hatch handles ejection, but the line between productive push and antagonism is implicit in operator skill, not formalized.
