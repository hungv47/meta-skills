...
1. Wrote `research/market-research.md` with frontmatter + 8 required sections.
...
3. No prior `research/market-research.md` to version-rename (first run).
...
- **Stale prior `research/market-research.md`.** A re-run scenario would read prior artifact for context but re-fetch via WebSearch (Critical Gate 4) and version-rename prior to `.v1.md` on output.
