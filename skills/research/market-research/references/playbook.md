...
- **Building customer personas.** That's `icp-research` — demographics, pain, VoC, habitats, decision psychology. market-research is market-side; icp-research is audience-side. They're parallel-with peers, not substitutes.
...
- **Planning marketing campaigns from market data.** That's `campaign-plan` — channel mix, calendar, IMC. market-research informs the targeting; doesn't write the plan.
