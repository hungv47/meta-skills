...
3. **Experience (read, don't ask):** `.forsvn/experience/product.md` (Product one-liner if persisted by a prior skill) + `.forsvn/experience/audience.md` (primary persona / pain points / geo focus if persisted by a prior skill).
