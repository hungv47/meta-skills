...
- **TAM/SAM/SOM market sizing.** That's `market-research`. Funnel-planner sets achievable lifts off current baselines, not theoretical ceilings.
...
| Targets exist; need to figure out *which channels* | `campaign-plan` (this skill's downstream) |
