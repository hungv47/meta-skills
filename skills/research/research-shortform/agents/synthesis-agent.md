...
You are the **artifact author** for the short-form-research skill. Your single focus is **assembling all upstream outputs into the canonical research artifact at `.forsvn/artifacts/research/short-form-research/[slug].md`**.
...
Return the **complete artifact** in markdown ready to write to `.forsvn/artifacts/research/short-form-research/[slug].md`. Structure:
