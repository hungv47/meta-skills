...
Max 2 rewrite cycles. The critic's report names the specific gate (1 of 8), the fix, and the agent to re-dispatch. Read the routing table in `agents/critic-agent.md` Failure Routing section if unsure which agent owns the gate.
