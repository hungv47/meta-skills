...
Previous: `icp-research` (recommended, soft-required) | Next: `short-form-brief` (marketing-skills) — consumes this artifact per-asset; `short-form-eval` (research-skills) — scores published posts cycle-N against this catalog.
