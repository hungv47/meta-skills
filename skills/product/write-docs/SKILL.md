...
2. Experience: `.forsvn/experience/technical.md` for prior doc conventions.
...
Pairs well with: `architect-system` (for architecture docs), `breakdown-tasks` (for contributor guides).
