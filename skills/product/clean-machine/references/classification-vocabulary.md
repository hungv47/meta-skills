...
- `clean-artifacts` (meta-skill) reads recent machine-cleanup reports to surface staleness signals (if the same dotfolder reappears 3 times in 3 runs, the user's tools-tried-and-abandoned rate is high).
