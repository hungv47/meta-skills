...
| User response | Action |
|---|---|
| "Approve" | Write brief to `.forsvn/artifacts/marketing/brief-landing-page/[slug]/brief.md` (with version subfolder if rev). Status DONE. |
| "Revise X" | Re-dispatch named layer with feedback (1 cycle) |
| "Reject" | Save as `.forsvn/artifacts/marketing/brief-landing-page/[slug]/rejected.md`, exit BLOCKED |
...
★ Gate 3 (Final Brief Acceptance — user approves, revises 1 cycle, or rejects to BLOCKED)
  ↓
Write artifacts to .forsvn/artifacts/marketing/brief-landing-page/[slug]/
```
