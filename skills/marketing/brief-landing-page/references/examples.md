...
### Output
- `.forsvn/artifacts/mkt/lp-brief/pricing/brief.md` (412 lines)
- `.forsvn/artifacts/mkt/lp-brief/pricing/handoff-claude-design.md`
- `.forsvn/artifacts/mkt/lp-brief/pricing/handoff-designer.md`
- `.forsvn/artifacts/mkt/lp-brief/pricing/asset-slots/hero-receipt.prompt.md`
- `.forsvn/artifacts/mkt/lp-brief/pricing/asset-slots/og-image.prompt.md`
- Status: **DONE**
...
- Prior brief: `.forsvn/artifacts/mkt/lp-brief/pricing/v1/brief.md`.
...
### Output
- `.forsvn/artifacts/mkt/lp-brief/pricing/v2/brief.md` (438 lines)
...
- Prior briefs: v1, v2 at `.forsvn/artifacts/mkt/lp-brief/pricing/`.
...
### Output
- `.forsvn/artifacts/mkt/lp-brief/pricing/v3/brief.md` (522 lines)
