...
Single per-dim score < 6 = FAIL even if aggregate ≥ 49. The asymmetry catches contaminated-but-otherwise-passing cycles (e.g., a 4 on Engagement-Quality Discrimination hidden under 8s everywhere else = a keep claim built on a vanity spike).
