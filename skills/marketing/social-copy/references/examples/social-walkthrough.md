...
```
/social-copy linkedin --variants 2 --goal click
```
...
```
Found:
- platform → linkedin (from /social-copy flag)
...
**Path:** `.agents/skill-artifacts/mkt/copy/linkedin-2026-05-18-fire-the-hubspot-stack.md`
