...
1. **Default behavior:** overwrite `.agents/skill-artifacts/mkt/design-briefs/[slug].md` with `version: N+1`, updated `date`.
...
```
.agents/skill-artifacts/mkt/design-briefs/[slug].critic-notes.md
```
