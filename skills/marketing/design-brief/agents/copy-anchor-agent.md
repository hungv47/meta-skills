...
| **content_artifact** | markdown \| null | `.agents/skill-artifacts/mkt/content/[slug].md` if a relevant copy artifact exists |
...
- **Pull from content artifact first** — if `.agents/skill-artifacts/mkt/content/[slug].copy.md` exists with a hook/CTA already, use those. Don't second-guess copywriting's craft.
