...
Both surfaces are AI-mediated discovery, but they retrieve, format, and route traffic differently. Auditing one without the other typically reveals only half the diagnosis. The `seo` skill's `mode=ai` covers both surfaces.
