...
If `icp-research.md` is absent, recommend running `icp-research` first; do not improvise generic personas — those produce generic recommendations that don't match the buyer the brand is actually trying to reach.
