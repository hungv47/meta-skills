...
> Load this when writing or reading `.forsvn/artifacts/mkt/aeo-monitor/[slug]/`. Conventions are contract-level — schema changes break trend computation across runs and the `optimize-seo` handoff consumer.
...
Source snapshot: `.forsvn/artifacts/mkt/aeo-monitor/[slug]/report.md` ([date])
