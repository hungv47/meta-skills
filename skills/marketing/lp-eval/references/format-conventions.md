...
|---|---|---|
| `skills-resources/loops/[slug]/evals/YYYY-MM-DD-cycle-N.md` | evaluation | Primary artifact, one per cycle |
| `skills-resources/loops/[slug]/results.tsv` | evaluation | Append exactly one row via `bun scripts/append-loop-result.ts` (validated 8-column helper) |
| `skills-resources/loops/[slug]/learnings.md` | learning | Update ONLY for high-confidence keep/discard lessons reusable beyond this exact page state; critic gates the promotion |
...
Save to `skills-resources/loops/[slug]/evals/YYYY-MM-DD-cycle-N.md`:
...
1. **Write eval artifact** at `skills-resources/loops/[slug]/evals/YYYY-MM-DD-cycle-N.md`
