...
1. **Pipeline artifacts:**
   ...
   - `.agents/skill-artifacts/mkt/campaign-plan.md` → channel mix + sequencing if outbound is part of a broader campaign
2. **Experience:** `skills-resources/experience/{audience,product,business}.md` → Voice notes, proof points, target-fit observations from prior runs
...
|---|---|---|---|
| 7. Proof points | `skills-resources/experience/product.md` | `Product — proof points` | Durable across cold-outreach + copywriting + lp-brief runs |
...
- **VoC pain language** — from icp-research.md if present
