...
```
.forsvn/artifacts/mkt/copy/[platform]-[YYYY-MM-DD]-[slug].md
```
...
- `brief_source` — either a path (`./.forsvn/artifacts/mkt/short-form-brief/<slug>/brief.md`) OR an inline topic string. Tracks provenance.
