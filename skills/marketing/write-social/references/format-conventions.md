...
```
.forsvn/artifacts/marketing/copy/[platform]-[YYYY-MM-DD]-[slug].md
```
...
- `brief_source` — either a path (`./.forsvn/artifacts/marketing/brief-shortform/<slug>/brief.md`) OR an inline topic string. Tracks provenance.
