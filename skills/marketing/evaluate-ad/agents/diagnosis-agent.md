...
- **Source ad-copy artifact** (`.forsvn/artifacts/marketing/write-ad/[audience-temp]-[date]-[slug].md`) — read the hook, anchor, audience-temp framing, CTA, hypothesis, and `.rationale.md` if present
