...
**Pattern:** Cycle artifact's provenance lists `input_artifacts: .forsvn/artifacts/mkt/ad-copy/cold-traffic-2026-05-01-paint-pourer.md` — but the file doesn't exist (typo, moved, never written).
