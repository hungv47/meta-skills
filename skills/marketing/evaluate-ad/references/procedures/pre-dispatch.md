...
5. **Source ad-copy artifact** at `.forsvn/artifacts/mkt/write-ad/[audience-temp]-[date]-[slug].md` (and `.rationale.md` if present) — the brief's hypothesis is the benchmark for Diagnosis
...
3. What is the source ad-copy artifact path? (typically .forsvn/artifacts/mkt/write-ad/[audience-temp]-[date]-[slug].md)
