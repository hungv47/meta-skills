...
4. No `.forsvn/artifacts/mkt/campaign-plan.md` (standalone landing page, not part of broader campaign)
...
Orchestrator writes single artifact to `.forsvn/artifacts/mkt/content/statuszero-landing.copy.md`:
