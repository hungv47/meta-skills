...
The 14 hero body sections appear in this order with these exact headers (downstream consumers — currently human producers; potentially `short-form-eval` if it expands — match on H2):
