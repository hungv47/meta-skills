...
| **context** | object | `{ research_artifact_excerpt: string }` — orchestrator-curated per-platform sections from the matching `.agents/skill-artifacts/research/short-form-research/[slug].md` artifact |
