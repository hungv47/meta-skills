...
### Output
- `.agents/skill-artifacts/mkt/lp-brief/pricing/brief.md` (412 lines)
- `.agents/skill-artifacts/mkt/lp-brief/pricing/handoff-claude-design.md`
- `.agents/skill-artifacts/mkt/lp-brief/pricing/handoff-designer.md`
- `.agents/skill-artifacts/mkt/lp-brief/pricing/asset-slots/hero-receipt.prompt.md`
- `.agents/skill-artifacts/mkt/lp-brief/pricing/asset-slots/og-image.prompt.md`
- Status: **DONE**
...
- Prior brief: `.agents/skill-artifacts/mkt/lp-brief/pricing/v1/brief.md`.
...
### Output
- `.agents/skill-artifacts/mkt/lp-brief/pricing/v2/brief.md` (438 lines)
...
- Prior briefs: v1, v2 at `.agents/skill-artifacts/mkt/lp-brief/pricing/`.
...
### Output
- `.agents/skill-artifacts/mkt/lp-brief/pricing/v3/brief.md` (522 lines)
