...
written by `design-brief` today and other media-briefing agents as the stack
...
- `asset-slots/*.md` — per-asset generative prompts (per slot, written by `design-brief` or future media-briefing agents)
