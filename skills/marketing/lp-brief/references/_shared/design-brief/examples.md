...
`.agents/skill-artifacts/mkt/design/standups-killed-og/`
- `brief.md` (concept A)
...
**Copy-anchor:** 8 slides of copy from `.agents/skill-artifacts/mkt/content/pricing-tiers.md` (content-create produced earlier).
...
`.agents/skill-artifacts/mkt/design/pricing-tiers-carousel-ig/`
- `brief.md`
- `render.pen`
- `critic.md`
...
Saved to `.agents/skill-artifacts/mkt/design/icon-style-artboard/render.html`. **NOT** roundtripped into `brand/`.
...
`.agents/skill-artifacts/mkt/design/hero-billboard/`
- `brief.md`
- `figma-spec.md`
- `critic.md`
