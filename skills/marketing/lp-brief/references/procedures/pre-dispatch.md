...
After cold-start answers, append to `skills-resources/experience/`:
...
| Condition | Action |
|---|---|
| `brand/BRAND.md` AND/OR `brand/DESIGN.md` absent | Return NEEDS_CONTEXT immediately; recommend `brand-system` (do NOT proceed to Cold Start) |
