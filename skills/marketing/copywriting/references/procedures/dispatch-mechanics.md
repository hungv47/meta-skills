...
- **Need page architecture (not just copy)?** → `lp-brief` first, then copywriting per section
- **Need full campaign orchestration?** → `campaign-plan` first, then copywriting per touchpoint
