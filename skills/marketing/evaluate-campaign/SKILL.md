...
- **Rubric:** `references/rubric.md` [RUBRIC] — the domain 7-dim 0-10 Pass/Fail instrument (5 shared dims + 2 campaign-specific; provisional v0.1, revision-triggered per brief 05). Shared frame — pass gate, scoring scale, universal Hard Fails, falsifiability discipline — in `references/_shared/evaluation-loop-rubric.md`
