...
| **context** | object | `{ research_artifact_excerpt: string }` — orchestrator-curated per-platform sections from the matching `.forsvn/artifacts/research/short-form-research/[slug].md` artifact |
