...
- [`_shared/platform-intelligence/`](_shared/platform-intelligence/) — per-platform deep dives (tiktok, reels, shorts, linkedin, x, youtube) loaded by format-agent + platform-tailor-agent. Canonical at top-level `references/platform-intelligence/` (D13)
