...
- **Existing context:**
  ...
  - `.forsvn/artifacts/research/short-form-research/dev-tools-vn.md` exists (8d old trends, 22d old mechanics — fresh)
...
1. `.forsvn/artifacts/research/short-form-research/dev-tools-vn.md` → found, trends 8d (fresh), mechanics 22d (fresh)
...
- `.forsvn/artifacts/mkt/short-form-brief/standup-bot/brief.md` (hero, 14 sections per `format-conventions.md`)
- `.forsvn/artifacts/mkt/short-form-brief/standup-bot/variants/reels.md` (variant, abbreviated 5-section set after "What Changed From Hero")
...
```
✓ Hero brief at .forsvn/artifacts/mkt/short-form-brief/standup-bot/brief.md
✓ Reels variant at .forsvn/artifacts/mkt/short-form-brief/standup-bot/variants/reels.md
