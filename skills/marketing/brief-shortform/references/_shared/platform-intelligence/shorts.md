<!-- GENERATED SUPPORT FILE. Canonical lives at references/platform-intelligence/shorts.md (repo root). Sync helper deferred to D14 — edit canonical first, then re-copy here. -->
