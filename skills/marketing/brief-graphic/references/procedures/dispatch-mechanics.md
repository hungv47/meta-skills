...
- **"Stop"** → save as `.forsvn/artifacts/mkt/design-briefs/[slug]-candidates.md`, exit BLOCKED.
...
User responses:
- **"Approve"** →
  1. Write `.forsvn/artifacts/mkt/design-briefs/[slug].md`.
...
- **"Reject"** → save as `.forsvn/artifacts/mkt/design-briefs/[slug]-rejected.md` with a `Rejection Notes` block, exit BLOCKED.
