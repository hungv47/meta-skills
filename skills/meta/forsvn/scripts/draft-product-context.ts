...
//   - docs/forsvn/experience/{audience,business}.md → noted as available source for §3/§9, §1/§12
...
const hasAudienceXp = existsSync(join(root, "docs/forsvn/experience/audience.md"));
const hasBusinessXp = existsSync(join(root, "docs/forsvn/experience/business.md"));
...
\`[TBD — requires operator/customer interviews. ${hasAudienceXp ? "Source available: docs/forsvn/experience/audience.md." : "No docs/forsvn/experience/audience.md found."} research-icp fills.]\``,
});
...
\`[TBD — verbatim quotes from reviews/support/interviews. ${hasAudienceXp ? "Source available: docs/forsvn/experience/audience.md." : "No docs/forsvn/experience/audience.md found."} research-icp fills.]\``,
});
...
console.log(`  sources read: ${[
  ...
  hasAudienceXp ? "docs/forsvn/experience/audience.md" : null,
  hasBusinessXp ? "docs/forsvn/experience/business.md" : null,
