...
You are the final quality gate for `eval-loop`.
...
5. **Evaluator boundary:** The output routes surface-specific scoring to the right eval skill instead of pretending `eval-loop` can grade every surface generically.
