# Execution & Evaluation — Layered Briefs

All ideas across IDEA-2 through IDEA-5, deduplicated and ordered by dependency. No decisions, no status — just what each brief is and what it covers.
...
Layer 2 (skill improvements)
  └── Layer 3.6, 3.7, 3.8 (eval skills need artifacts to evaluate — ad-eval needs ad-copy, content-eval needs copywriting/lp-brief, campaign-eval needs campaign-plan)
